...
// inputs (see GPTAttentionCustomPlugin::isEntryUsed for when each tensor is actually used)
...
class GPTAttentionCustomPlugin : public GPTAttentionPluginCommon
{
public:
    GPTAttentionCustomPlugin(int num_heads, int num_kv_heads, int head_size, int unidirectional, float q_scaling,
    ...
    GPTAttentionCustomPlugin(const void* data, size_t length);

    ~GPTAttentionCustomPlugin() override = default;
    ...
    GPTAttentionCustomPlugin* clone() const noexcept override;
...
class GPTAttentionCustomPluginCreator : public GPTAttentionPluginCreatorCommon
{
public:
    GPTAttentionCustomPluginCreator();
