...
class PluginConfig(object):
    ...
    def init(self):
        ...
        # [x] For custom plugins
        self.gpt_attention_custom_plugin = False
    ...
    # [x] For custom plugins
    def set_gpt_attention_custom_plugin(self, dtype='float16'):
        self.gpt_attention_custom_plugin = dtype
        return self
