...
def read_config(config_path: Path) -> Tuple[ModelConfig, dict]:
    ...
    use_gpt_attention_custom_plugin = bool(plugin_config['gpt_attention_custom_plugin'])
    ...
    model_config = ModelConfig(
        ...
        # [x] For a custom plugin
        gpt_attention_plugin=use_gpt_attention_custom_plugin,
        ...
        if engine_version is None:
            ...
            model_config = ModelConfig(
                ...
                gpt_attention_plugin=bool(
                    build_config.plugin_config.gpt_attention_custom_plugin),
