...
class BuildConfig:
    ...
    def from_dict(cls, config):
        ...
        gpt_attention_custom_plugin = config.pop('gpt_attention_custom_plugin', False)
        if gpt_attention_custom_plugin:
            plugin_config.set_gpt_attention_custom_plugin(dtype=gpt_attention_custom_plugin)
